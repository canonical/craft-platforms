.. meta::
  :description: An explanation of the documentation system, process, and writing style and conventions in Craft Platforms.
...
The documentation is an essential part of Craft Platforms. We make documentation a disciplined
...
Craft Platforms practices docs-as-code. The document source files are written in
reStructuredText markup and kept inside the Craft Platforms source code. Like the rest of the
...
The Craft Platforms maintainers try and review every PR in a timely manner, typically within a
...
There is no single way to write, but there are guidelines and patterns that Craft Platforms
documents follow:
