...
Craft Platforms has a community from all over the world, and the Starcraft team
welcomes all contributions.

Contributing offers an opportunity to polish your technical skills, develop as a
professional, and get involved in the growing open source community. Craft Platforms
...
The Starcraft team at Canonical sets the direction and priorities of Craft Platforms.
They take responsibility for its stewardship and health.

Before you start work on Craft Platforms, there are three documents for you to digest.
...
Craft Platforms is licensed under [LGPL-3.0](LICENSE).

## Report an issue or open a request

If you find a bug or feature gap in Craft Platforms, look for it in the [project's
GitHub issues](https://github.com/canonical/craft-platforms/issues) first. If you have
fresh input, add your voice to the issue.

If the bug or feature doesn't have an issue, we invite you to [open
one](https://github.com/canonical/craft-platforms/issues/new/choose).

## Set up for development

Craft Platforms uses a forking, feature-based workflow. Most work occurs on people's
local systems, and is heavily terminal-dependent. Remote testing and building is
provided on GitHub for continuous integration and delivery.

Start by [creating a personal
fork](https://github.com/canonical/craft-platforms/fork) of the repository on GitHub.
...
```bash
git clone git@github.com:<username>/craft-platforms
cd craft-platforms
git remote add upstream git@github.com:canonical/craft-platforms
git fetch upstream
```
...
```bash
git clone https://github.com/<username>/craft-platforms
cd craft-platforms
...
All significant work in Craft Platforms should be tied to an existing issue or ticket.

Once you find an issue that you'd like to work on, it's best to reach out so that a
maintainer can assign the ticket to you before starting. This process varies depending
on the issue's complexity and scope.
...
one](https://github.com/canonical/craft-platforms/issues/new/choose) and indicate that
you're interested in taking it on. When creating the issue, be sure to add any relevant
labels. A maintainer will then review the issue and assign it to you.
...
[Diátaxis](https://diataxis.fr) category for the page. A maintainer will review your
proposal and, if everything looks complete, assign the issue to you.
...
If you're contributing to the next release, run:
...
Craft Platforms's test suite includes unit and integration tests. If you're not sure
...
Platforms's documentation is built around.
...
On GitHub, [open a PR](https://github.com/canonical/craft-platforms/compare) for your
branch in Craft Platforms.
...
The maintainers try to review every PR in a timely manner, typically within a week for
contributions that resolve an approved issue. While they can't guarantee immediate
feedback, they aim to ensure that all contributions are reviewed thoroughly and
thoughtfully.
